...
@interface SFIntroductionVCTypeTwo () <UIScrollViewDelegate>
...
@implementation SFIntroductionVCTypeTwo
...
+( UIViewController*)createWithWithCoverImages:(NSArray*)coverImages backgroundImages:(NSArray* )bgImages button:(UIButton*)button enterBlock:(void(^)())enterBlock {
    ...
    SFIntroductionVCTypeTwo *two=nil;
    if (button) {
        two=[[SFIntroductionVCTypeTwo alloc]initWithCoverImageNames:coverImages backgroundImageNames:bgImages];
    } else {
        two=[[SFIntroductionVCTypeTwo alloc]initWithCoverImageNames:coverImages backgroundImageNames:bgImages button:button];
    }
    two.didSelectedEnter=enterBlock;
    return two;
}
